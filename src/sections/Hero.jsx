...
const Hero = () => {
    return (
        <section
            id="home"
            className="max-xlg:w-screen flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container "
        >

            <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-lg:padding-x pt-28">

                <p className="text-xl font-montserrat text-coral-red">Our Summer Collections</p>
                <h1 className="mt-10 font-palanquin text-8xl max-sm:font-[42px] max-sm:leading-[82] font-bold">
            ...
            <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-center bg-cover">
                <img src={bigShoe1} alt="Hero Shoe Image" width={610} height={500} className="object-contain z-10" />
            </div>
